...
namespace od
{
    ...
    MainMenu::MainMenu(GuiManager &gm)
    {
        ...
        topLeft->setTextureCoordsFromPixels(osg::Vec2i(0, 0), osg::Vec2i(255, 255));
        ...
        topRight->setTextureCoordsFromPixels(osg::Vec2i(0, 0), osg::Vec2i(255, 255));
        ...
        bottomLeft->setTextureCoordsFromPixels(osg::Vec2i(0, 0), osg::Vec2i(255, 255));
        ...
        bottomRight->setTextureCoordsFromPixels(osg::Vec2i(0, 0), osg::Vec2i(255, 255));
